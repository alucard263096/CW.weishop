				 ...
				 <div class="form-group">
									...
									<script>
										...
										document.getElementById("alipay_paytype").value="<?php  echo empty($configs['alipay_paytype'])?0:$configs['alipay_paytype'];?>";
												 ...
												 <div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 支付手续费：</label>

										<div class="col-sm-9">
											 <input type="text" name="alipay_payfee" class="col-xs-10 col-sm-2" value="<?php  echo $configs['alipay_payfee'];?>" />
										</div>
									</div>
