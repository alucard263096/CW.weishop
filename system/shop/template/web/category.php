...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" >
	...
	<input type="hidden" name="parentid" value="<?php  echo $parent['id'];?>" />
		   ...
		   <div class="form-group">
			   ...
			   <div class="form-group">
									...
									<input type="text" name="catename" class="col-xs-10 col-sm-2" value="<?php  echo $category['name'];?>" />
									   ...
									   <div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 分类图片<?php  echo $category['thumb'];?></label>
	  ...
	  <div class="form-group">
						...
						<input type="text" name="description" class="col-xs-10 col-sm-2" value="<?php  echo $category['description'];?>" />
												</div>
									</div>
