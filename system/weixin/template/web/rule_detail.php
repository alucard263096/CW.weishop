...
<form method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return formcheck(this)" >
	<input type="hidden" name="id" value="<?php  echo $rule['id'];?>">
			...
			<div class="form-group">
					...
					function keywordstypeAction($init)
					{
						if(document.getElementById('rule-type-keywords').value==0)
						{
			...
			<div class="form-group">
										...
										<div class="col-sm-9">
										   			<input type="text" class="span2" placeholder="" id="rule-keywords"  name="keywords" value="<?php  echo $rule['keywords'];?>" /> <select name="ruletypekeywords" id="rule-type-keywords" class="span2" onchange="keywordstypeAction()" >
						<option value="0" >自定义关键字</option>
			...
			<div class="form-group">
										...
										<div class="col-sm-9">
										   		<span id="urltr2" >
					<input type="text" class="span6" placeholder="" id="rule-url"  name="url" value="<?php  echo $rule['url'];?>" /> &nbsp;
					<br>
...
<script>
	...
	document.getElementById('rule-type-keywords').value=<?php if($rule['keywords']==default_key){ echo 1;}else{ if($rule['keywords']==subscribe_key){ echo 2;}else{echo 0;}} ?>;
