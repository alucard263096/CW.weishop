...
<h3 class="header smaller lighter blue">余额充值</h3>
   ...
   <div class="form-group">
			...
			<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
													<input type='text' name='remark' maxlength="20" class="col-xs-10 col-sm-2" value="后台余额充值" />  
										</div>
									</div>
									
		<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 充值余额：</label>
