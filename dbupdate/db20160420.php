...
INSERT INTO `baijiacms_rule` VALUES ('商家管理', 'merchant', 'merchant', '15');
CREATE TABLE `baijiacms_district` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(20) NULL,
  PRIMARY KEY (`id`))
COMMENT = '区';
insert into baijiacms_district (name) value ('罗湖区');
insert into baijiacms_district (name) value ('福田区');
insert into baijiacms_district (name) value ('南山区');
insert into baijiacms_district (name) value ('宝安区');
insert into baijiacms_district (name) value ('龙岗区');
insert into baijiacms_district (name) value ('盐田区');
insert into baijiacms_district (name) value ('光明新区');
insert into baijiacms_district (name) value ('坪山新区');
insert into baijiacms_district (name) value ('龙华新区');
insert into baijiacms_district (name) value ('罗湖区');

CREATE TABLE `baijiacms_merchant` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `no` VARCHAR(45) NULL,
...
CREATE TABLE `weishop`.`baijiacms_merchant_piclist` (
